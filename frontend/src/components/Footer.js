      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Your premier destination for custom printed products. We combine quality craftsmanship with innovative designs to bring your ideas to life.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/returns" className="text-gray-300 hover:text-white transition-colors">Return Policy</Link></li>
          ...
          <div className="space-y-4">
            ...
            <address className="text-gray-300 not-italic space-y-2">
              <div className="flex items-start">
                ...
                <span>123 Print Street, Print City, PC 12345</span>
              </div>
              <div className="flex items-center">
                <svg className="h-5 w-5 mr-2 text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:info@printmine.com" className="hover:text-white transition-colors">info@printmine.com</a>
              </div>
              <div className="flex items-center">
                <svg className="h-5 w-5 mr-2 text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          <div className="md:flex md:items-center md:justify-between">
            <div className="md:w-1/2 mb-4 md:mb-0">
              ...
              <p className="text-gray-300 text-sm">Get the latest updates on new products and upcoming sales</p>
            </div>
            <div className="md:w-1/2">
              <form className="flex">
                <input
                  ...
                  className="flex-grow px-4 py-2 rounded-l-md border-0 bg-gray-700 text-white placeholder-gray-400 focus:ring-2 focus:ring-indigo-500"
                  required
                />
                <button
                  type="submit"
                  className="px-6 py-2 rounded-r-md bg-gradient-to-r from-purple-500 to-indigo-600 text-white font-medium hover:from-purple-600 hover:to-indigo-700 transition-colors"
                >
                  Subscribe
                </button>
              </form>
        ...
        <div className="mt-8 pt-6 border-t border-gray-700 text-center">
          ...
          <p className="text-gray-500 text-xs mt-2">
            Designed with ❤️ for creative minds everywhere
          </p>
        </div>
      </div>
    </footer>
